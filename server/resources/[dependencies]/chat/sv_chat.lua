...
AddEventHandler('__cfx_internal:commandFallback', function(command)
    -- Do NOT broadcast unknown commands to all players.
    -- Keep feedback local to the player who typed it.
    TriggerClientEvent('chat:addMessage', source, {
        color = { 255, 120, 120 },
        multiline = true,
        args = { 'System', ('Unbekannter Befehl: /%s'):format(command) }
    })
...
local function refreshCommands(player)
    -- Suggestions werden serverseitig von rp_admin verwaltet,
    -- damit jeder Spieler nur wirklich erlaubte Befehle sieht.
